			...
			["Cantherle"] = {
				...
				["forms"] = {
					...
					["BattleCommon"] = {
						...
						[52] = "# Revenge 5 rage",
						[53] = "#",
						[54] = "callForm=Revenge-ifStance=defensive-ifPlayer>5rage-ifNotInCooldown=revenge-ifTargetBlocked",
						[55] = "#callForm=DrinkRagePotion-ifPlayer<5rage-ifNotInCooldown=revenge-ifTargetParried",
						[56] = "callForm=Revenge-ifPlayer>5rage-ifNotInCooldown=revenge-ifTargetParried",
						[57] = "#",
						[58] = "# Mocking Blow 10 rage 2 min cooldown, Taunt 0 rage",
						[59] = "#",
						[60] = "callForm=MockingBlowTaunt-ifNotTargetOfTarget-ifTargetHasTarget",
						[61] = "#",
						[62] = "# Whirlwind 25 rage 10 sec cooldown",
						[63] = "#",
						[64] = "callForm=Whirlwind-ifPlayer>25%hp-ifNotInCooldown=whirlwind-ifPlayer>25rage",
						[65] = "#",
						[66] = "# Hamstring 10 rage",
						[67] = "#",
						[68] = "callForm=DrinkRagePotion-ifPlayer<10rage-ifTargetType=Humanoid-ifTarget<50%hp-ifNotTargetHasDebuff=hamstring-ifNotTargetHasDebuff=judgeJustice-ifNotTargetImmune=hamstring",
						[69] = "callForm=Hamstring-ifPlayer>10rage-ifTargetType=Humanoid-ifTarget<50%hp-ifNotTargetHasDebuff=hamstring-ifNotTargetHasDebuff=judgeJustice-ifNotTargetImmune=hamstring",
						[70] = "callForm=DrinkRagePotion-ifPlayer<10rage-ifTargetType=Humanoid-ifNotTargetHasDebuff=hamstring-ifNotTargetHasDebuff=judgeJustice-ifNotTargetImmune=hamstring-ifTimeToDeath<15s",
						[71] = "callForm=Hamstring-ifPlayer>10rage-ifTargetType=Humanoid--ifNotTargetHasDebuff=hamstring-ifNotTargetHasDebuff=judgeJustice-ifNotTargetImmune=hamstring-ifTimeToDeath<15s",
						[72] = "#",
						[73] = "# Bloodrage 0 rage",
						[74] = "#",
						[75] = "bloodrage-echo=Bloodrage!-ifNotInCooldown=bloodrage-ifNotPlayerHasBuff=bloodrage-ifPlayer>60hp-ifPlayer>10%hp",
						[76] = "#",
						[77] = "# Shield Block 10 rage",
						[78] = "#",
						[79] = "callForm=ShieldBlock-ifPlayer>10rage-ifNotInCooldown=shieldBlock-ifPlayer<33%hp-ifNotPlayerHasBuff=shieldBlock",
						[80] = "callForm=ShieldBlock-ifStance=defensive-ifPlayer>35rage-ifNotInCooldown=shieldBlock-ifPlayer<50%hp-ifNotPlayerHasBuff=shieldBlock",
						[81] = "#",
						[82] = "# Battle Shout 10 rage",
						[83] = "#",
						[84] = "battleShout-echo=Battle Shout!-ifPlayer>10rage-ifNotPlayerHasBuff=battleShout",
						[85] = "battleShout-echo=Battle Shout!-ifPlayer>10rage-ifBuffDuration<3s=battleShout",
						[86] = "#",
						[87] = "# Disarm 20 rage",
						[88] = "#",
						[89] = "callForm=Disarm-ifStance=defensive-ifNotInCooldown=disarm-ifPlayer>45rage-ifNotTargetImmune=disarm-ifNotTargetType=Beast,Critter,Dragonkin,Elemental-ifNotTargetHasDebuff=disarm",
						[90] = "#",
						[91] = "# Rend 10 rage",
						[92] = "#",
						[93] = "rend-echo=Not in melee range!-ifNotTargetInMeleeRange",
						[94] = "rend-echo=Rend!-ifPlayer>35rage-ifPlayerHasBuff=battleShout-ifNotTargetHasDebuff=rend-ifNotTargetImmune=rend-ifTimeToDeath>15s",
						[95] = "#",
						[96] = "# Demoralizing Shout 10 rage",
						[97] = "#",
						[98] = "demoShout-echo=Demoralizing Shout!-ifPlayer>35rage-ifPlayerHasBuff=battleShout-ifNotTargetHasDebuff=demoShout",
					},
					["Whirlwind"] = {
						[1] = "berserk-sayInSay=Berserk for Whirlwind-ifNotStance=berserk",
						[2] = "whirlwind",
					},
					["Bandage"] = {
