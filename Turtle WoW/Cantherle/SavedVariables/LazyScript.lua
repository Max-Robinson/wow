			...
			["Cantherle"] = {
				...
				["forms"] = {
					...
					["Cleave"] = {
						...
						[4] = "#",
						[5] = "battle-echo=Battle stance for Sweeping Strikes!-ifStance=defensive-ifPlayer>25%hp-ifPlayer>25rage-ifNotInCooldown=sweepingStrikes",
					...
					["SweepingStrikes"] = {
						...
						[3] = "#",
						[4] = "battle-echo=Battle stance for Sweeping Strikes!-ifStance=defensive-ifPlayer>25%hp-ifPlayer>25rage-ifNotInCooldown=sweepingStrikes",
						[5] = "sweepingStrikes-echo=Sweeping Strikes!-ifStance=battle-ifPlayer>30rage-ifNotInCooldown=sweepingStrikes",
					},
					["ShieldWall"] = {
					...
					["BattleCommon"] = {
						...
						[57] = "callForm=Revenge-ifStance=defensive-ifPlayer>5rage-ifNotInCooldown=revenge-ifTargetParried",
						[58] = "#",
						[59] = "# Mocking Blow 10 rage 2 min cooldown, Taunt 0 rage",
						[60] = "#",
						[61] = "callForm=MockingBlowTaunt-ifNotTargetOfTarget-ifTargetHasTarget",
						[62] = "#",
						[63] = "# Whirlwind 25 rage 10 sec cooldown",
						[64] = "#",
						[65] = "callForm=Whirlwind-ifPlayer>25%hp-ifNotInCooldown=whirlwind-ifPlayer>25rage",
						[66] = "#",
						[67] = "# Hamstring 10 rage",
						[68] = "#",
						[69] = "callForm=DrinkRagePotion-ifPlayer<10rage-ifTargetType=Humanoid-ifTarget<50%hp-ifNotTargetHasDebuff=hamstring-ifNotTargetHasDebuff=judgeJustice-ifNotTargetImmune=hamstring",
						[70] = "callForm=Hamstring-ifPlayer>10rage-ifTargetType=Humanoid-ifTarget<50%hp-ifNotTargetHasDebuff=hamstring-ifNotTargetHasDebuff=judgeJustice-ifNotTargetImmune=hamstring",
						[71] = "callForm=DrinkRagePotion-ifPlayer<10rage-ifTargetType=Humanoid-ifNotTargetHasDebuff=hamstring-ifNotTargetHasDebuff=judgeJustice-ifNotTargetImmune=hamstring-ifTimeToDeath<15s",
						[72] = "callForm=Hamstring-ifPlayer>10rage-ifTargetType=Humanoid--ifNotTargetHasDebuff=hamstring-ifNotTargetHasDebuff=judgeJustice-ifNotTargetImmune=hamstring-ifTimeToDeath<15s",
						[73] = "#",
						[74] = "# Bloodrage 0 rage",
						[75] = "#",
						[76] = "bloodrage-echo=Bloodrage!-ifNotInCooldown=bloodrage-ifNotPlayerHasBuff=bloodrage-ifPlayer>60hp-ifPlayer>10%hp",
						[77] = "#",
						[78] = "# Shield Block 10 rage",
						[79] = "#",
						[80] = "callForm=ShieldBlock-ifPlayer>10rage-ifNotInCooldown=shieldBlock-ifPlayer<33%hp-ifNotPlayerHasBuff=shieldBlock",
						[81] = "callForm=ShieldBlock-ifStance=defensive-ifPlayer>35rage-ifNotInCooldown=shieldBlock-ifPlayer<50%hp-ifNotPlayerHasBuff=shieldBlock",
						[82] = "#",
						[83] = "# Battle Shout 10 rage",
						[84] = "#",
						[85] = "battleShout-echo=Battle Shout!-ifPlayer>10rage-ifNotPlayerHasBuff=battleShout",
						[86] = "battleShout-echo=Battle Shout!-ifPlayer>10rage-ifBuffDuration<3s=battleShout",
						[87] = "#",
						[88] = "# Disarm 20 rage",
						[89] = "#",
						[90] = "callForm=Disarm-ifStance=defensive-ifNotInCooldown=disarm-ifPlayer>45rage-ifNotTargetImmune=disarm-ifNotTargetType=Beast,Critter,Dragonkin,Elemental-ifNotTargetHasDebuff=disarm",
						[91] = "#",
						[92] = "# Rend 10 rage",
						[93] = "#",
						[94] = "rend-echo=Not in melee range!-ifNotTargetInMeleeRange",
						[95] = "rend-echo=Rend!-ifPlayer>35rage-ifPlayerHasBuff=battleShout-ifNotTargetHasDebuff=rend-ifNotTargetImmune=rend-ifTimeToDeath>15s",
						[96] = "#",
						[97] = "# Demoralizing Shout 10 rage",
						[98] = "#",
						[99] = "demoShout-echo=Demoralizing Shout!-ifPlayer>35rage-ifPlayerHasBuff=battleShout-ifNotTargetHasDebuff=demoShout",
					},
					["DrinkHealingPotion"] = {
