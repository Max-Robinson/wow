		...
		["Turtle WoW"] = {
			["Cantherle"] = {
				...
				["forms"] = {
					...
					["BattleCommon"] = {
						[1] = "autoAttack",
						[2] = "use=Lesser Healthstone-echo=Lesser Healthstone!-ifInCombat-ifPlayer<10%hp-ifNotItemInCooldown=Lesser Healthstone",
						[3] = "use=Healing Potion-echo=Healing Potion!-ifInCombat-ifPlayer<10%hp-ifNotItemInCooldown=Healing Potion",
						[4] = "#Intimidating Shout 25 rage",
						[5] = "intimidatingShout-echo=Intimidating Shout!-ifNotInCooldown=intimidatingShout-ifItemInCooldown=Healing Potion-ifPlayer<20%hp-ifPlayer>25rage",
					...
					["MockingBlowTaunt"] = {
						...
						[7] = "challengingShout-echo=Challenging Shout!-ifInCooldown=taunt-ifNotInCooldown=challengingShout-ifPlayer>5rage",
					},
					["Cleave"] = {
						[1] = "callForm=BattleCommon",
						[2] = "# Cleave 20 rage",
