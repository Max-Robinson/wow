			...
			["Cantherle"] = {
				...
				["forms"] = {
					...
					["SweepingStrikes"] = {
						...
						[3] = "#",
						[4] = "battle-echo=Battle stance for Sweeping Strikes!-ifStance=defensive-ifPlayer>30%hp-ifPlayer>25rage-ifNotInCooldown=sweepingStrikes",
					...
					["BattleCommon"] = {
						...
						[14] = "#",
						[15] = "callForm=ShieldWall-ifNotInCooldown=shieldWall-ifPlayer<15%hp",
						[16] = "#",
						...
						[64] = "#",
						[65] = "callForm=Whirlwind-ifStance=defensive-ifPlayer>30%hp-ifNotInCooldown=whirlwind-ifPlayer>25rage",
						[66] = "callForm=Whirlwind-ifNotStance=defensive-ifPlayer>20%hp-ifNotInCooldown=whirlwind-ifPlayer>25rage",
						[67] = "#",
						...
						[80] = "#",
						[81] = "callForm=ShieldBlock-ifPlayer>10rage-ifNotInCooldown=shieldBlock-ifPlayer<20%hp-ifNotPlayerHasBuff=shieldBlock",
					...
					["ShieldBash"] = {
						[1] = "defensive-echo=DefensiveStance for Shield Bash!-ifStance=berserk-ifPlayer<20%hp",
						[2] = "battle-echo=BattleStance for Shield Bash!-ifStance=berserk-ifPlayer>20%hp",
