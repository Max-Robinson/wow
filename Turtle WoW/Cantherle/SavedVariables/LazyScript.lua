			...
			["Cantherle"] = {
				...
				["forms"] = {
					...
					["EquipShield"] = {
						...
						[3] = "equipMainHand=Hardened Iron Shortsword-ifNotEquipped=Hardened Iron Shortsword",
						[4] = "equipOffHand=Gold Lion Shield-echo=Equipping shield-ifNotEquipped=Gold Lion Shield",
					},
					["BattleCommon"] = {
						[1] = "autoAttack",
						[2] = "use=Lesser Healthstone-sayInSay=Lesser Healthstone!-ifInCombat-ifPlayer<10%hp-ifNotItemInCooldown=Lesser Healthstone",
						[3] = "use=Greater Healing Potion-sayInSay=Healing Potion!-ifInCombat-ifPlayer<10%hp-ifNotItemInCooldown=Greater Healing Potion",
						...
						[36] = "callForm=Hamstring-ifPlayer>10rage-ifTargetType=Humanoid--ifNotTargetHasDebuff=hamstring-ifNotTargetImmune=hamstring-ifTimeToDeath<15s",
						[37] = "# Bloodrage 0 rage",
						[38] = "bloodrage-echo=Bloodrage!-ifNotInCooldown=bloodrage-ifNotPlayerHasBuff=bloodrage-ifPlayer>60hp-ifPlayer>10%hp",
						[39] = "# Shield Block 10 rage",
						[40] = "callForm=ShieldBlock-ifPlayer>10rage-ifNotInCooldown=shieldBlock-ifPlayer<33%hp-ifNotPlayerHasBuff=shieldBlock",
						[41] = "callForm=ShieldBlock-ifStance=defensive-ifPlayer>35rage-ifNotInCooldown=shieldBlock-ifPlayer<50%hp-ifNotPlayerHasBuff=shieldBlock",
						[42] = "# Battle Shout 10 rage",
						[43] = "battleShout-echo=Battle Shout!-ifPlayer>10rage-ifNotPlayerHasBuff=battleShout",
						[44] = "battleShout-echo=Battle Shout!-ifPlayer>10rage-ifBuffDuration<3s=battleShout",
						[45] = "# Disarm 20 rage",
						[46] = "callForm=Disarm-ifStance=defensive-ifNotInCooldown=disarm-ifPlayer>45rage-ifNotTargetImmune=disarm-ifNotTargetType=Beast,Critter,Dragonkin,Elemental-ifNotTargetHasDebuff=disarm",
						[47] = "# Rend 10 rage",
						[48] = "rend-echo=Not in melee range!-ifNotTargetInMeleeRange",
						[49] = "rend-echo=Rend!-ifPlayer>35rage-ifPlayerHasBuff=battleShout-ifNotTargetHasDebuff=rend-ifNotTargetImmune=rend-ifTimeToDeath>15s",
						[50] = "# Demoralizing Shout 10 rage",
						[51] = "demoShout-echo=Demoralizing Shout!-ifPlayer>35rage-ifPlayerHasBuff=battleShout-ifNotTargetHasDebuff=demoShout",
					},
					["Hamstring"] = {
						...
						[5] = "hamstring-sayInSay=Hamstring!-ifStance=battle",
					},
					["Bandage"] = {
					...
					["EquipTwoHandWeapon"] = {
						[1] = "equipMainHand=Cobalt Crusher-echo=Equipping 2 hander-ifNotEquipped=Cobalt Crusher",
					},
					["Buff"] = {
						[1] = "findHerbs",
