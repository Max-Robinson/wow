			...
			["Cantherle"] = {
				...
				["forms"] = {
					["ThunderClap"] = {
						...
						[3] = "callForm=ThunderClapSub-ifPlayer>45rage-ifNotInCooldown=thunderClap-ifNotTargetHasDebuff=thunderClap-ifNotLastUsed>4s=thunderClap-ifNotStance=berserk",
					...
					["PummelShieldBash"] = {
						...
						[7] = "# priority",
						[8] = "#",
						[9] = "berserk-echo=Berserk for Pummel!-ifNotStance=berserk-ifEquipped=Whirlwind Axe-ifNotLastUsed>1s=berserk-ifPlayer>10%hp",
						[10] = "#",
						[11] = "# Pummel 10 rage 10s cooldown requires Berserker",
						[12] = "#",
						[13] = "pummel-ifStance=berserk-ifNotInCooldown=pummel-ifNotLastUsed>10s=pummel-ifNotTargetImmune=pummel",
						[14] = "#",
						[15] = "# Shield Bash 10 rage 12s cooldown Not berserker stance",
						[16] = "#",
						[17] = "callForm=EquipShield-ifNotStance=berserk-ifNotLastUsed>12s=shieldBash-ifNotTargetImmune=shieldBash-ifPlayer<10%hp",
						[18] = "defensive-echo=Defensive for Shield Bash!-ifStance=berserk-ifNotLastUsed>1s=defensive-ifNotLastUsed>12s=shieldBash-ifNotTargetImmune=shieldBash-ifPlayer<10%hp",
						[19] = "# Shield Bash has 12 second cooldown",
						[20] = "shieldBash-sayInSay=Shield Bash!-ifNotStance=berserk-ifNotLastUsed>12s=shieldBash-ifNotTargetImmune=shieldBash-ifEquipped=Salbac Shield",
					},
					["SweepingStrikes"] = {
						[1] = "#",
						...
						[4] = "# Battle Stance",
						[5] = "#",
						[6] = "battle-echo=Battle stance for Sweeping Strikes!-ifStance=defensive-ifPlayer>30%hp-ifPlayer>25rage-ifNotInCooldown=sweepingStrikes-ifNotLastUsed>30s=sweepingStrikes-ifNotLastUsed>1s=battle",
						[7] = "#",
						[8] = "# Sweeping Strikes",
						[9] = "#",
						[10] = "sweepingStrikes-echo=Sweeping Strikes!-ifStance=battle-ifPlayer>30rage-ifNotInCooldown=sweepingStrikes-ifNotLastUsed>30s=sweepingStrikes",
					},
					["ShieldWall"] = {
					...
					["BattleCommon"] = {
						...
						[4] = "#",
						[5] = "callForm=BerserkerRage-ifPlayerIs=Feared-ifNotLastUsed>30s=berserkerRage-ifNotInCooldown=berserkerRage",
						[6] = "callForm=BerserkerRage-ifPlayerIs=Incapacitated-ifNotLastUsed>30s=berserkerRage-ifNotInCooldown=berserkerRage",
						[7] = "#",
						...
						[17] = "#",
						[18] = "callForm=ShieldWall-ifNotInCooldown=shieldWall-ifPlayer<15%hp-ifNotLastUsed>1800s=shieldWall",
						[19] = "#",
						...
						[25] = "#",
						[26] = "intimidatingShout-sayInSay=Intimidating Shout!-ifNotInCooldown=intimidatingShout-ifPlayer<10%hp-ifPlayer>25rage-ifNotLastUsed>180s=intimidatingShout",
						[27] = "#",
						...
						[33] = "#",
						[34] = "callForm=Retaliation-ifNotInCooldown=retaliation-ifPlayer<20%hp-ifItemInCooldown=Greater Healing Potion-ifInCooldown=shieldWall-ifNotPlayerHasBuff=shieldWall-ifNotLastUsed>1800s=shieldWall",
						[35] = "#",
						...
						[52] = "#Overpower 5 rage",
						[53] = "#",
						[54] = "callForm=DrinkRagePotion-ifPlayer<5rage-ifNotInCooldown=overpower-ifTargetDodged-ifNotLastUsed>5s=overpower",
						[55] = "callForm=Overpower-ifPlayer>5rage-ifNotInCooldown=overpower-ifTargetDodged-ifNotLastUsed>5s=overpower",
						[56] = "#",
						[57] = "# Revenge 5 rage 5s cooldown",
						[58] = "#",
						[59] = "callForm=Revenge-ifStance=defensive-ifPlayer>5rage-ifNotInCooldown=revenge-ifTargetBlocked-ifNotLastUsed>5s=revenge",
						[60] = "callForm=Revenge-ifStance=defensive-ifPlayer>5rage-ifNotInCooldown=revenge-ifTargetParried-ifNotLastUsed>5s=revenge",
						[61] = "#",
						...
						[67] = "#",
						[68] = "callForm=Whirlwind-ifStance=defensive-ifPlayer>30%hp-ifNotInCooldown=whirlwind-ifPlayer>25rage-ifNotLastUsed>10s=whirlwind",
						[69] = "callForm=Whirlwind-ifNotStance=defensive-ifPlayer>20%hp-ifNotInCooldown=whirlwind-ifPlayer>25rage-ifNotLastUsed>10s=whirlwind",
						[70] = "#",
						...
						[79] = "#",
						[80] = "bloodrage-echo=Bloodrage!-ifNotInCooldown=bloodrage-ifNotPlayerHasBuff=bloodrage-ifPlayer>232hp-ifPlayer>10%hp-ifNotLastUsed>60s=bloodrage",
						[81] = "#",
						[82] = "# Shield Block 10 rage 5s cooldown",
						[83] = "#",
						[84] = "callForm=ShieldBlock-ifPlayer>10rage-ifNotInCooldown=shieldBlock-ifPlayer<20%hp-ifNotPlayerHasBuff=shieldBlock-ifNotLastUsed>5s=shieldBlock",
						[85] = "callForm=ShieldBlock-ifStance=defensive-ifPlayer>35rage-ifNotInCooldown=shieldBlock-ifPlayer<50%hp-ifNotPlayerHasBuff=shieldBlock-ifNotLastUsed>5s=shieldBlock",
						[86] = "#",
						[87] = "# Battle Shout 10 rage 2 min.  Alow recasting when almost out",
						[88] = "#",
						[89] = "battleShout-echo=Battle Shout!-ifPlayer>10rage-ifNotPlayerHasBuff=battleShout-ifNotLastUsed>120s=battleShout",
						[90] = "#battleShout-echo=Battle Shout!-ifPlayer>10rage-ifBuffDuration<3s=battleShout-ifNotLastAction=battleShout-ifNotLastUsed>100s=battleShout",
						[91] = "#",
						[92] = "# Disarm 20 rage 1m cooldown",
						[93] = "#",
						[94] = "callForm=Disarm-ifStance=defensive-ifNotInCooldown=disarm-ifPlayer>45rage-ifNotTargetImmune=disarm-ifNotTargetType=Beast,Critter,Dragonkin,Elemental-ifNotTargetHasDebuff=disarm-ifNotLastUsed>60s=disarm",
						[95] = "#",
					...
					["MockingBlowTaunt"] = {
						...
						[3] = "#",
						[4] = "mockingBlow-sayInSay=Mocking Blow!-ifStance=battle-ifPlayer>10rage-ifNotInCooldown=mockingBlow-ifNotLastUsed>120s=mockingBlow",
						[5] = "#",
						[6] = "# Taunt 0 rage 10 sec cooldown",
						[7] = "#",
						[8] = "taunt-sayInSay=Taunt!-ifStance=defensive-ifNotInCooldown=taunt-ifNotLastUsed>10s=taunt",
						[9] = "#",
						[10] = "# Challenging Shout 5 rage 10 min cooldown",
						[11] = "#",
						[12] = "challengingShout-sayInSay=Challenging Shout!-ifNotStance=defensive-ifNotInCooldown=challengingShout-ifPlayer>5rage-ifNotLastUsed>600s=challengingShout",
						[13] = "challengingShout-sayInSay=Challenging Shout!-ifStance=defensive-ifInCooldown=taunt-ifNotInCooldown=challengingShout-ifPlayer>5rage-ifNotLastUsed>600s=challengingShout",
						[14] = "#",
						[15] = "#  Taunt 0 rage 10 sec cooldown",
						[16] = "#",
						[17] = "defensive-echo=Defensive Stance for Taunt!-ifNotLastUsed>1s=defensive-ifNotStance=defensive-ifNotInCooldown=taunt-ifNotLastUsed>10s=taunt",
						[18] = "taunt-sayInSay=Taunt!-ifStance=defensive-ifNotInCooldown=taunt-ifNotLastUsed>10s=taunt",
					},
					["EquipTwoHandWeapon"] = {
					...
					["ChargeIntercept"] = {
						...
						[6] = "berserk-sayInSay=Berserk for Intercept-ifInCombat-ifPlayer>10rage-ifNotStance=berserk-ifNotInCooldown=intercept-ifNotLastUsed>30s=intercept",
						[7] = "intercept-ifInCombat-ifPlayer>10rage-ifNotInCooldown=intercept-ifNotLastUsed>30s=intercept",
						[8] = "#",
						[9] = "# Charge 0 rage 15 sec cooldown",
						[10] = "#",
						[11] = "sayInSay=Charge in cooldown-ifNotInCombat-ifInCooldown=charge",
						[12] = "battle-sayInSay=Battle Stance for charge-ifNotInCombat-ifNotInCooldown=charge-ifNotStance=battle-ifNotLastUsed>15s=charge",
						[13] = "charge-ifNotInCombat-ifNotInCooldown=charge-ifNotLastUsed>15s=charge",
					},
					["Execute"] = {
