			...
			["Cantherle"] = {
				...
				["forms"] = {
					...
					["BattleCommon"] = {
						...
						[26] = "# Bloodrage 0 rage",
						[27] = "bloodrage-sayInSay=Bloodrage!-ifNotInCooldown=bloodrage-ifNotPlayerHasBuff=bloodrage-ifPlayer>60hp-ifPlayer>10%hp",
						...
						[31] = "battleShout-sayInSay=Battle Shout!-ifPlayer>10rage-ifNotPlayerHasBuff=battleShout",
						[32] = "battleShout-sayInSay=Battle Shout!-ifPlayer>10rage-ifBuffDuration<3s=battleShout",
						[33] = "# Disarm 20 rage",
						...
						[35] = "# Rend 10 rage",
						[36] = "rend-sayInSay=Not in melee range!-ifNotTargetInMeleeRange",
						[37] = "rend-sayInSay=Rend!-ifPlayer>35rage-ifPlayerHasBuff=battleShout-ifNotTargetHasDebuff=rend-ifNotTargetImmune=rend-ifTimeToDeath>15s",
						[38] = "# Demoralizing Shout 10 rage",
						[39] = "demoShout-sayInSay=Demoralizing Shout!-ifPlayer>35rage-ifPlayerHasBuff=battleShout-ifNotTargetHasDebuff=demoShout",
					},
					["Hamstring"] = {
