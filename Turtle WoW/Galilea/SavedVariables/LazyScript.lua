			...
			["Galilea"] = {
				...
				["forms"] = {
					...
					["Buff"] = {
						...
						[4] = "fearWard-ifNotTargetHasBuff=fearWard",
						...
						[15] = "fearWard@self-ifNotHasBuff=fearWard",
						[16] = "fearWard@party1-ifNotParty1HasBuff=fearWard",
						[17] = "fearWard@party2-ifNotParty2HasBuff=fearWard",
						[18] = "fearWard@party3-ifNotParty3HasBuff=fearWard",
						[19] = "#fearWard@party4-ifNotParty4HasBuff=fearWard",
						[20] = "#fearWard@partypet1-ifNotPartypet1HasBuff=fearWard",
						[21] = "#fearWard@partypet2-ifNotPartypet2HasBuff=fearWard",
